  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-gradient-to-r from-blue-500/3 to-purple-500/3 rounded-full blur-3xl animate-spin" style={{ animationDuration: '25s' }}></div>
      </div>
                    ...
                    <div className="relative flex items-center justify-center gap-3">
                      {loading ? (
                        <>
                          ...
                          <span className="text-lg tracking-wider">Creating Stockist...</span>
                        </>
                      ) : (
                        <>
                          <Package size={20} />
                          <span className="text-lg tracking-wider">CREATE STOCKIST</span>
                        </>
                      )}
                    </div>
