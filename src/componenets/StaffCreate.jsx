    ...
    <div className="min-h-screen flex items-start justify-center p-6" style={{backgroundColor: '#f8fafc'}}>
      <div className="w-full max-w-2xl bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-semibold text-gray-800">Create Staff</h2>
          <p className="text-gray-500 mt-1">Add new team member information</p>
        </div>
            ...
            <div>
              ...
              <div className="border-2 border-dashed border-gray-200 rounded-xl p-6 text-center hover:border-blue-300 transition-colors">
                ...
                <input
                  ...
                  required
                />
                <p className="text-xs text-gray-500 mt-1">Upload profile photo</p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="border-2 border-dashed border-gray-200 rounded-xl p-6 text-center hover:border-blue-300 transition-colors">
                ...
                <input
                  ...
                  required
                />
                <p className="text-xs text-gray-500 mt-1">Upload Aadhar card image</p>
              </div>
            </div>
          </div>
