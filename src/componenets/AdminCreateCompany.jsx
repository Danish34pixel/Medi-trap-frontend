            ...
            <div className="relative z-10">
              ...
              <div className="text-center mb-12 relative">
                ...
                <div className="absolute -top-3 left-1/3 transform -translate-x-1/2">
                  <Building2 className="text-indigo-400 animate-bounce delay-300" size={16} />
                </div>
                <div className="absolute -top-3 right-1/3 transform translate-x-1/2">
                  <Factory className="text-purple-400 animate-bounce delay-700" size={16} />
                </div>
                    ...
                    <div className="relative flex items-center justify-center gap-3">
                      {loading ? (
                        <>
                          ...
                          <span className="text-lg tracking-wider">Creating Company...</span>
                        </>
                      ) : (
                        <>
                          <Building2 size={20} />
                          <span className="text-lg tracking-wider">CREATE COMPANY</span>
                        </>
                      )}
                    </div>
